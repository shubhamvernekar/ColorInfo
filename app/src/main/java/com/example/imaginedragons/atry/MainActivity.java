package com.example.imaginedragons.atry;
...
public class MainActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = (ImageView)findViewById(R.id.back);
         b = (TextView) findViewById(R.id.hexcode);
         b1 = (TextView)findViewById(R.id.rgb);
         b3 = (TextView)findViewById(R.id.colname);
    ...
    public void PickColor(View view) {
        ColorPickerDialogBuilder
               .with(this)
                ...
                .initialColor(Color.rgb(200,100,80))
                ...
                .setPositiveButton("ok", new ColorPickerClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int selectedColor, Integer[] allColors) {
                       back.setBackgroundColor(selectedColor);
                       b.setText("#"+Integer.toHexString(selectedColor));
                       getRGB(selectedColor);
    ...
    public void getRGB(int color){
        ...
        b = Color.blue(color);
        b1.setText(""+r+","+g+","+b);
        b3.setText(""+getColorNameFromRgb(r,g,b));
    }
...
public void hello(int col){

    back.setBackgroundColor(col);
    b.setText("#"+Integer.toHexString(col));
    getRGB(col);
}

    public void iv1(View view) {
     hello(Color.parseColor("#60c36e"));
    }
    public void iv2(View view) {
        hello(Color.parseColor("#0000ff"));
    }
    public void iv3(View view) {
        hello(Color.parseColor("#87919b"));
    }
    public void iv4(View view) {
        hello(Color.parseColor("#646496"));
    }
    public void iv5(View view) {
        hello(Color.parseColor("#4b0d2b"));

    }
    public void iv6(View view) {
        hello(Color.parseColor("#e9b704"));

    }
    public void iv7(View view) {
        hello(Color.parseColor("#82486b"));

    }
    public void iv8(View view) {
        hello(Color.parseColor("#e6699c"));

    }
    public void iv9(View view) {
        hello(Color.parseColor("#105d5c"));

    }
    public void iv10(View view) {
        hello(Color.parseColor("#c7a6bc"));

    }
    public void iv11(View view) {
        hello(Color.parseColor("#b4d8c1"));

    }
    public void iv12(View view) {
        hello(Color.parseColor("#e9b704"));

    }
    public void iv13(View view) {
        hello(Color.parseColor("#897587"));

    }
    public void iv14(View view) {
        hello(Color.parseColor("#5c6558"));

    }
    public void iv15(View view) {
        hello(Color.parseColor("#0d8e8f"));

    }
    public void iv16(View view) {
        hello(Color.parseColor("#a28684"));
